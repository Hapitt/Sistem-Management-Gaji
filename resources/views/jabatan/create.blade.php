    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body bg-light bg-gradient">
            <h5 class="fw-bold text-dark mb-1">
                <i class="fas fa-briefcase me-2 text-primary"></i> Tambah Jabatan
            </h5>
            <p class="text-muted mb-0">Silakan isi informasi jabatan baru yang ingin ditambahkan.</p>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-sm-9 offset-sm-2 text-end">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-2"></i> Tambah Jabatan
                        </button>
                    </div>
                </div>
            </form>
