    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body bg-light bg-gradient">
            <h5 class="fw-bold text-dark mb-1">
                <i class="fas fa-star text-warning me-2"></i> Tambah Rating
            </h5>
            <p class="text-muted mb-0">Silakan isi informasi rating baru yang ingin ditambahkan.</p>
        </div>
    </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-9">
                        <input type="number" step="0.01" id="rating" name="rating" 
                            ...
                            value="{{ old('rating') }}" required placeholder="Masukkan nilai rating...">
                        @error('rating')
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-9">
                        <input type="number" step="0.01" id="presentase_bonus" name="presentase_bonus" 
                            ...
                            value="{{ old('presentase_bonus') }}" required placeholder="Masukkan persentase bonus...">
                        <small class="text-muted">
                            Sisa bonus yang tersedia: {{ $sisaBonus * 100 }}%
                        </small>
                ...
                <div class="row">
                    <div class="col-sm-9 offset-sm-2 text-end">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-2"></i> Tambah Rating
                        </button>
                    </div>
                </div>
